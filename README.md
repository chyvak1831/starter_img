...
│   │   │   ├── components/                 # → Component scss folder
│   │   │   |   ├── _carousel.scss          # → Carousels
│   │   │   |   ├── _components.scss        # → Collect all component files
│   │   │   |   ├── _footer.scss            # → Footer
│   │   │   |   ├── _header.scss            # → Header
│   │   │   |   ├── _modal.scss             # → Modal
│   │   │   |   └── _wishlist.scss          # → TI wishlist styles
│   │   │   ├── mixins/                     # → Mixin scss folder
...
│   │   │   |   ├── _select2.scss           # → Select2: default woo feature - used on checkout, account
