...
│   │   │   ├── comment.js                  # → Custom script sources
│   │   │   ├── common.js                   # → Custom script sources
│   │   │   ├── filters.js                  # → Custom script sources
│   │   │   ├── home_page.js                # → Custom script sources
│   │   │   ├── product_add_remove.js       # → Custom script sources
│   │   │   ├── product_hover.js            # → Custom script sources
│   │   │   ├── single_product.js           # → Custom script sources
│   │   │   └── step_nav.js                 # → Custom script sources
│   │   ├── iosPreloadFix.js                # → Custom script sources
│   │   ├── list_plugins.js                 # → Custom script sources
│   │   ├── list_scripts.js                 # → Custom script sources
│   │   ├── plugins.js                      # → Custom script sources
│   │   └── scripts.js                # → Custom script sources
│   ├── scss/                               # → Styles
│   └── svg-icons.svg                       # → Svg icons - used for decor in theme (i.e. not content)
├── inc/                                    # → PHP logic
│   ├── acf-json/                           # → ACF
